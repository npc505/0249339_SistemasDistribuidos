...
const (
	Log_Produce_FullMethodName       = "/logs.Log/Produce"
	Log_Consume_FullMethodName       = "/logs.Log/Consume"
	Log_ConsumeStream_FullMethodName = "/logs.Log/ConsumeStream"
	Log_ProduceStream_FullMethodName = "/logs.Log/ProduceStream"
)
